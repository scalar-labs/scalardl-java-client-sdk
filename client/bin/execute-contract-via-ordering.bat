...
@rem ##########################################################################
@rem
@rem  execute-contract-via-ordering startup script for Windows
@rem
@rem ##########################################################################
...
@rem Add default JVM options here. You can also use JAVA_OPTS and EXECUTE_CONTRACT_VIA_ORDERING_OPTS to pass JVM options to this script.
...
@rem Execute execute-contract-via-ordering
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %EXECUTE_CONTRACT_VIA_ORDERING_OPTS%  -classpath "%CLASSPATH%" com.scalar.client.tool.ContractExecutionViaOrdering %CMD_LINE_ARGS%
...
:fail
rem Set variable EXECUTE_CONTRACT_VIA_ORDERING_EXIT_CONSOLE if you need the _script_ return code instead of
rem the _cmd.exe /c_ return code!
if  not "" == "%EXECUTE_CONTRACT_VIA_ORDERING_EXIT_CONSOLE%" exit 1
exit /b 1
